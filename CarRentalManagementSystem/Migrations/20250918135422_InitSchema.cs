        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RentPerDay = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    PerKmRate = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LicenseFrontImage = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    LicenseBackImage = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExtraKM = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.InsertData(
                table: "Cars",
                columns: new[] { "CarID", "CarModel", "CarName", "CarType", "CreatedAt", "FuelType", "ImageUrl", "IsAvailable", "Mileage", "NumberPlate", "PerKmRate", "RentPerDay", "SeatingCapacity", "Status" },
                values: new object[,]
                {
                    { 1, "2023", "Toyota Corolla", "Sedan", new DateTime(2025, 9, 18, 19, 24, 21, 951, DateTimeKind.Local).AddTicks(3160), "Petrol", "/images/cars/corolla.jpg", true, 15.5, "ABC-1234", 50m, 5000m, 5, "Available" },
                    { 2, "2023", "Honda Civic", "Sedan", new DateTime(2025, 9, 18, 19, 24, 21, 951, DateTimeKind.Local).AddTicks(3164), "Petrol", "/images/cars/civic.jpg", true, 14.800000000000001, "XYZ-5678", 55m, 6000m, 5, "Available" }
                });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "UserID", "CreatedAt", "Password", "Role", "Username" },
                values: new object[] { 1, new DateTime(2025, 9, 18, 19, 24, 21, 951, DateTimeKind.Local).AddTicks(2322), "$2a$11$g3XCwFLyORzFe7tz06K6ZOUtwZ4P46rapW2.Ry9ZER4.1PRHPawqu", "Admin", "admin" });
